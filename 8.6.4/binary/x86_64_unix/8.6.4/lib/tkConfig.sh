...
TK_LIBS='-L/usr/lib64 -lX11 -lXss -lXext -lXft   -lfontconfig  -lpthread -ldl -lz  -lpthread -lieee -lm'

# Top-level directory in which Tk's platform-independent files are
# installed.
TK_PREFIX='/Scr/scr-test-steven/install/tk/8.6.4'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/Scr/scr-test-steven/install/tk/8.6.4'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/Scr/scr-test-steven/Programs/TclTk/build_tk-8.6.4 -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Scr/scr-test-steven/install/tk/8.6.4/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Scr/scr-test-steven/install/tk/8.6.4/include'
...
# compiled.
TK_SRC_DIR='/Scr/scr-test-steven/Programs/TclTk/tk8.6.4'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/Scr/scr-test-steven/Programs/TclTk/build_tk-8.6.4 -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Scr/scr-test-steven/install/tk/8.6.4/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/Scr/scr-test-steven/Programs/TclTk/build_tk-8.6.4/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/Scr/scr-test-steven/install/tk/8.6.4/lib/libtkstub8.6.a'
